...
const missChecklists = [
  {
    ...
    updatedAt: savedAt,
    values: {
      impactLocationDetectedChecked: true,
      ...
      indicatorNameAndDirectionCodeMatchMissionChecked: true,
      indicatorNearTargetWeatherConditionsChecked: true,
      nearTargetWeatherWind: 'כן',
      nearTargetWeatherCloudsOrHaze: 'לא',
      nearTargetWeatherRain: 'לא',
      targetTypeChecked: true,
      targetType: 'מבנה',
      reflectiveTargetChecked: true,
      reflectiveTarget: 'לא',
      targetFaceChecked: true,
      targetFace: 'חזית דרום',
      multipleSpotsChecked: true,
      multipleSpots: 'לא',
      spotBouncedChecked: true,
      spotBounced: 'לא',
      deflectionDoneChecked: true,
      deflectionDone: 'לא',
      crossPositionChecked: true,
      crossPosition: 'מרכז',
      missileImpactRelativeToCrossChecked: true,
      ...
      fallingIndicatorsOkChecked: true,
