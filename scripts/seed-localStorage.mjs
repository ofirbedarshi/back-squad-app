...
const bachs = [
  {
    ...
    values: {
      ...
      targetName: 'יעד דמה א׳',
      detection: 'אופטי',
      targetCoords: { east: '400000', north: '4000000' },
      targetAltitude: '440',
      targetType: 'מבנה',
      targetDescription: 'מטרה לאימון',
      ...
      positionCoords: { east: '345678', north: '3456789' },
      ...
      indicatorName: 'מציין דמה א׳',
      indicatorPositionCoords: { east: '401234', north: '4012345' },
      indicatorAltitude: '430',
      observationMeans: 'אופטי',
      indicatorMeans: 'אופטי',
      indicatorKoz: '12',
  ...
  },
  {
    ...
    values: {
      ...
      targetName: 'יעד דמה ב׳',
      detection: 'מכ"ם',
      targetCoords: { east: '410000', north: '4100000' },
      targetAltitude: '395',
      targetType: 'רכב',
      ...
      positionCoords: { east: '456789', north: '4567890' },
