...
export const attackLogFormSchema: FormSchema = {
  fields: [
    ...
    },
    {
      ...
      key: 'result',
      label: 'תוצאה',
      options: ['פרגול', 'הפוכה', 'טוניס'],
      required: false,
    },
    { type: 'text', key: 'notes', label: 'הערות', required: false },
    ...
    { type: 'flightPath', key: 'flightPath', required: false },
    {
      ...
      key: 'offset',
      label: 'היסט',
      options: ['למעלה', 'למטה', 'ימינה', 'שמאלה', 'ללא'],
      required: false,
    },
    {
      type: 'toggle',
