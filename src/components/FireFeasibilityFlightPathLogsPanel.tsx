...
interface FireFeasibilityFlightPathLogsPanelProps {
  results: FireFeasibilityFlightPathResultsByGeneration
}

function FireFeasibilityFlightPathLogsPanel({ results }: FireFeasibilityFlightPathLogsPanelProps) {
...
export default FireFeasibilityFlightPathLogsPanel
