  ...
  ({ hasError = false, hasWarning = false, ...props }, ref) => {
    return (
      <textarea
        ...
        {...props}
        className={[
          'w-full py-3.5 px-4 rounded-2xl border text-base placeholder-neutral-400 outline-none shadow-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed disabled:bg-neutral-100 min-h-[120px] resize-y',
          hasError
