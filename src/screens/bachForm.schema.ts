...
export const bachFormSchema: FormSchema = {
  fields: [
    ...
    { type: 'row', fields: [
      { type: 'text', key: 'indicatorPositionName', label: 'שם עמדה' },
      { type: 'coords', key: 'indicatorPositionCoords', label: 'נ.צ. עמדה' },
    ]},
    { type: 'row', fields: [
      { type: 'text', key: 'indicatorAltitude', label: 'גובה' },
      { type: 'text', key: 'observationMeans', label: 'אמצעי תצפית' },
      { type: 'text', key: 'indicatorMeans', label: 'אמצעי מציין' },
    ]},
    { type: 'row', fields: [
      { type: 'text', key: 'indicatorKoz', label: 'קו"צ' },
