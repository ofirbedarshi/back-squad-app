  ...
  return (
    <div dir="rtl" className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="flex flex-col gap-4 p-4">
        <h3 className="font-bold text-neutral-800">קיפול העמדה:</h3>
        <ul className="flex flex-col gap-2 pr-4">
          ...
          <li className="list-disc text-neutral-700">
            <span className="bg-yellow-200 font-medium px-0.5">סנג'רים</span> מקפל את כבל ההרחקה לרכב.
          </li>
          <li className="list-disc text-neutral-700">
            <span className="bg-yellow-200 font-medium px-0.5">חמש</span> מנתק את הצמות מהטילים ומחבר את מחברי הקצר.
          </li>
          <li className="list-disc text-neutral-700">
          ...
          <li className="list-disc text-neutral-700">עליה לרכבים ותחילת תנועה.</li>
        </ul>
      </div>
    </div>
  )
...
export default SadapKipulDugScreen
